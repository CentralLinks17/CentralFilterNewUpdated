...
PICS = (environ.get('PICS', 'https://telegra.ph/file/7f4e1ba95b2902162baff.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/46443096bc6895c74a716.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://telegra.ph/file/7f4e1ba95b2902162baff.jpg")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1021404718 1103583723 1015200442').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002168020767')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002178123424')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️ - Central_Links')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://central-filter-kristybza-22a25788.koyeb.app/")
